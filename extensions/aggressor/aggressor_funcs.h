...
AGGRESSOR_FUNC("beacons",               BEACON)
AGGRESSOR_FUNC("beacon_ids",            BEACON)
AGGRESSOR_FUNC("beacon_info_set",        BEACON)
...
AGGRESSOR_FUNC("dialog",                UI)
AGGRESSOR_FUNC("dialog_show",           UI)
AGGRESSOR_FUNC("drow",                  UI)
AGGRESSOR_FUNC("drow_text",             UI)
AGGRESSOR_FUNC("dbutton",               UI)
AGGRESSOR_FUNC("dcheckbox",             UI)
AGGRESSOR_FUNC("dtext",                 UI)
AGGRESSOR_FUNC("dtextarea",             UI)
AGGRESSOR_FUNC("dcombobox",             UI)
AGGRESSOR_FUNC("dlist",                 UI)
AGGRESSOR_FUNC("dfile",                 UI)
